...
## Project Overview
This project focuses on Market Basket Analysis using a grocery dataset to uncover purchasing patterns and provide actionable business insights.
...
6. Generated association rules and filtered them based on lift.
7. Visualized the results.
8. Provided business insights and conclusions.

## Key Insights
- Insights derived from the analysis will be discussed in the notebook.
